    ...
    <div className='flex flex-col md:flex-row '>
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen font-thin bg-slate-200'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center  font-thin'>
          ...
          <div className='flex items-center gap-1 font-thin'>
            ...
            <button className='border w-40 text-center text-white bg-green-800 p-2 rounded-full shadow-lg hover:opacity-90'>
            Search
          </button>
          </div>
